...
console.log(`Site checks passed: ${routes.length} public routes + ${Object.keys(legacy).length} legacy redirect-compatible routes, canonical, sitemap, robots, manifest, schemas, H1s, image alt text, breadcrumbs, and 0 internal dead links.`);
